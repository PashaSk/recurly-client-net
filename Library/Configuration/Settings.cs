...
namespace Recurly.Configuration
{
    internal class Settings
    {
        ...
        public string PayPalAccounts { get; private set; }
        ...
        private Settings()
        {
            ...
            PayPalAccounts = Section.Current.PayPalAccounts;
        }

        internal Settings(string apiKey, string subdomain, string privateKey, int pageSize, string payPalAccounts)
        {
            ApiKey = apiKey;
            Subdomain = subdomain;
